const costumePage = document.querySelector(".products")
console.log(costumePage)
    
class Products {
    async getProducts() {
      try {
      let result = await fetch('http://localhost:3000/costumes.json'); 
      let data = await result.json();
      console.log(data)
      let products = data.costumes;
      return products
    } catch(error){
      console.log(error)
    }
            ...
            <div class="col">
                <div class="card mb-5" style="max-width: 1240px;">
                  <div class="row no-gutters">
                    <div class="col-md-4">
                      <img src=${product.image} class="card-img" alt="Dress">
                    </div>
                    <div class="col-md-8">
                      <div class="card-body">
